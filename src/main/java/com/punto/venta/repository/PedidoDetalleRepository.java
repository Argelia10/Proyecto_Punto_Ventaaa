...
public interface PedidoDetalleRepository extends JpaRepository<PedidoDetalle, Integer> {
    ...
    List<PedidoDetalle> findByEstadoTrueAndIdProductoNombreContainingIgnoreCase(String nombreProducto);

    List<PedidoDetalle> findTop2ByEstadoTrueAndIdProductoNombreContainingIgnoreCase(String nombreProducto);
}